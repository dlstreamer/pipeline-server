...
POST_SERVER_DETAILS=
POST_SERVER_STRING="    server server-name server-address:8080 check weight 100 agent-check agent-addr server-address agent-port 3333 agent-inter 5s  agent-send ping"
NEWLINE=$'\n'
